...
setwd("D:/ANALYTIX LAB/R/R Final Case Study/Predicting Credit Card Spend-Linear Regression Case/FINAL")
...
final_model= lm(ln_total_spend ~ lninc + debtinc+lncreddebt+othdebt+cardmon+cardten+gender + retire + card + card2,data = dev1)
summary(final_model)

dev1$cd1=cooks.distance(final_model)
dev2= subset(dev1,cd1<(4/3369))
